...
const profileData = {
  name: "Jesús Arrioja",
  title: {
    en: "TypeScript Backend Engineer | DevOps & Cloud Architecture",
    es: "TypeScript Backend Engineer | DevOps & Cloud Architecture",
  },
  bio: {
    en: "Backend Engineer specialized in TypeScript with over 8 years of experience building scalable solutions. I have designed real-time systems for AI video processing, marketplace platforms, and high-concurrency applications. My approach combines robust backend development with cloud infrastructure and DevOps best practices.",
    es: "Backend Engineer especializado en TypeScript con más de 8 años de experiencia construyendo soluciones escalables. He diseñado sistemas de tiempo real para procesamiento de video con AI, plataformas tipo marketplace, y aplicaciones de alta concurrencia. Mi enfoque combina desarrollo backend robusto con infraestructura cloud y mejores prácticas de DevOps.",
  },
...
const projectsData = [
  {
    ...
    gradient: { from: "#ffd7d5", to: "#ba797d" },
    isActive: true,
    isFeatured: true,
    order: 1,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#3f4e51", to: "#000000" },
    isActive: true,
    isFeatured: true,
    order: 4,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#00644f", to: "#002138" },
    isActive: true,
    isFeatured: true,
    order: 5,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#43d6f1", to: "#7c7eff" },
    isActive: true,
    isFeatured: false,
    order: 8,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#d6e3f3", to: "#b8abe1" },
    isActive: true,
    isFeatured: true,
    order: 10,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#3e3bab", to: "#5a52d5" },
    isActive: true,
    isFeatured: true,
    order: 12,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#ff4400", to: "#ff6633" },
    isActive: true,
    isFeatured: false,
    order: 13,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#ffff39", to: "#ffff66" },
    isActive: true,
    isFeatured: false,
    order: 14,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#ffffff", to: "#54d0e8" },
    isActive: true,
    isFeatured: false,
    order: 15,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#ffffff", to: "#009688" },
    isActive: true,
    isFeatured: false,
    order: 16,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#6fc4bf", to: "#0d6d74" },
    isActive: true,
    isFeatured: false,
    order: 17,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#00aa4e", to: "#0067c9" },
    isActive: true,
    isFeatured: false,
    order: 19,
    createdAt: Date.now(),
  ...
  },
  {
    ...
    gradient: { from: "#ffffff", to: "#a5c7d2" },
    isActive: true,
    isFeatured: false,
    order: 22,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#ffffff", to: "#e8dbdc" },
    isActive: true,
    isFeatured: false,
    order: 23,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#662a7e", to: "#a74499" },
    isActive: true,
    isFeatured: false,
    order: 24,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#e9d8c0", to: "#9a314d" },
    isActive: true,
    isFeatured: false,
    order: 25,
    createdAt: Date.now(),
  },
  {
    ...
    gradient: { from: "#81c1be", to: "#182636" },
    isActive: true,
    isFeatured: false,
    order: 26,
    createdAt: Date.now(),
  ...
  {
    name: { en: "RunaHR", es: "RunaHR" },
    slug: "runahr",
    logoUrl: "/images/runahr.png",
    url: "https://runahr.com/",
    features: [
      { en: "WordPress Development", es: "Desarrollo WordPress" },
      { en: "Custom Theme Development", es: "Desarrollo de Tema Personalizado" },
      { en: "WPO (Performance Optimization)", es: "WPO (Optimización de Rendimiento)" },
      { en: "Custom Plugins Development", es: "Desarrollo de Plugins Personalizados" },
      { en: "WPML Multilingual", es: "Multidioma con WPML" },
    ],
    agency: {
      name: "Mood Agency",
      logoUrl: "/images/mood-oscuro.png",
    ...
    gradient: { from: "#b794f6", to: "#6b46c1" },
    isActive: true,
    isFeatured: true,
    order: 34,
    createdAt: Date.now(),
  ...
  {
    name: { en: "Cautos", es: "Cautos" },
    slug: "cautos",
    logoUrl: "/images/cautos.png",
    url: "https://cautos.app/",
    features: [
      { en: "Uber-like Taxi App", es: "App de Taxi tipo Uber" },
      { en: "Landing Page Development", es: "Desarrollo de Landing Page" },
      { en: "TypeScript Backend", es: "Backend en TypeScript" },
      { en: "Supabase Integration", es: "Integración con Supabase" },
      { en: "Real-time Matching System", es: "Sistema de Matching en Tiempo Real" },
    ],
    gradient: { from: "#4299e1", to: "#48bb78" },
    isActive: true,
    isFeatured: true,
    order: 35,
    createdAt: Date.now(),
  ...
  {
    name: { en: "TwinRanks", es: "TwinRanks" },
    slug: "twinranks",
    logoUrl: "/images/twinranks.png",
    url: "https://twinranks.com/",
    features: [
      { en: "WordPress Blog", es: "Blog WordPress" },
      { en: "Elementor Page Builder", es: "Maquetador Elementor" },
      { en: "Steam API Integration", es: "Integración API de Steam" },
      { en: "Deals API Integration", es: "Integración API de Ofertas" },
      { en: "Custom Post Types", es: "Tipos de Publicación Personalizados" },
    ],
    agency: {
      name: "Mood Agency",
      logoUrl: "/images/mood-oscuro.png",
    ...
    gradient: { from: "#1b2838", to: "#66c0f4" },
    isActive: true,
    isFeatured: true,
    order: 36,
    createdAt: Date.now(),
